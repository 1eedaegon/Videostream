...
exports.postAddComment = exports.postRegisterView = exports.deleteVideo = exports.postEditVideo = exports.getEditVideo = exports.detailVideo = exports.postUpload = exports.getUpload = exports.search = exports.home = void 0;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            console.log(_context2.t0, searchingBy, req.query.term);
...
var postUpload = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(req, res) {
    var _req$body, title, description, url, newVideo;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            //  => url.split('?)[0]
            _req$body = req.body, title = _req$body.title, description = _req$body.description, url = req.file.url;
            _context3.next = 3;
          ...
          case 3:
            ...
            req.user.save();
            res.redirect(_routes["default"].detailVideo(newVideo.id));
...
var detailVideo = /*#__PURE__*/function () {
  ...
  return function detailVideo(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();

exports.detailVideo = detailVideo;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 4:
            ...
            if (!("".concat(video.creator) !== req.user.id)) {
              _context5.next = 9;
              break;
            }
    ...
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 4:
            res.redirect(_routes["default"].detailVideo(id));
            _context6.next = 11;
            break;
