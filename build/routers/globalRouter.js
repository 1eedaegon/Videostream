...
globalRouter.get(_routes["default"].home, _videoController.home); // Join
...
globalRouter.post(_routes["default"].login, _middlewares.onlyPublic); // Logout & Search

globalRouter.get(_routes["default"].search, _videoController.search);
globalRouter.get(_routes["default"].logout, _middlewares.onlyPrivate, _userController.logout); // Github
...
}), _userController.postGithubLogin); // Facebook
...
globalRouter.get(_routes["default"].facebookCallback, _passport["default"].authenticate('facebook', {
  failureRedirect: '/login'
}), _userController.postFacebookLogin); // Kakao
...
}), _userController.postKakaoLogin); // User detail
